...
class DRCOGDataset(dataset.Dataset):
  ...
  def fetch_buildings(self,building_sqft_per_job_table='building_sqft_per_job',bsqft_job_scaling=1.0):
    ...
    bsqft_job = self.store[building_sqft_per_job_table]
    bsqft_job.building_sqft_per_job = bsqft_job.building_sqft_per_job*bsqft_job_scaling
    buildings = pd.merge(buildings,bsqft_job,left_on=['zone_id','building_type_id'],right_index=True,how='left')
