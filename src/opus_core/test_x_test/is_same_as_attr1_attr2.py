...
class is_same_as_attr1_attr2(Variable):
    """A variable for unit tests.
    """ 
    _return_type="bool8"
        
    def compute(self, dataset_pool):
        values = self.get_dataset().is_same_as('attr1', 'attr2')
        return values
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "opus_core.test_x_test.is_same_as_attr1_attr2"
    ...
    def test(self):
        ...
        should_be = array([[1, 1, 0], [0, 0, 0], [1, 1, 0]])
