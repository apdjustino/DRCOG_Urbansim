...
class multiply_attr1_attr2(Variable):
    """A variable for unit tests.
    """ 
    _return_type="float32"
        
    def compute(self, dataset_pool):
        values = self.get_dataset().multiply('attr1', 'attr2')
        return values
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "opus_core.test_x_test.multiply_attr1_attr2"
