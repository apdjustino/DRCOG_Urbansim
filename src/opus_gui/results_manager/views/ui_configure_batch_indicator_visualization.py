...
class Ui_dlgConfigureBatchIndicatorVisualization(object):
    def setupUi(self, dlgConfigureBatchIndicatorVisualization):
        ...
        self.appendTypeCheckBox = QtGui.QCheckBox(self.groupBox)
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), dlgConfigureBatchIndicatorVisualization.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), dlgConfigureBatchIndicatorVisualization.reject)
    ...
    def retranslateUi(self, dlgConfigureBatchIndicatorVisualization):
        ...
        self.appendTypeCheckBox.setText(QtGui.QApplication.translate("dlgConfigureBatchIndicatorVisualization", "Append Column Type To Column Name", None, QtGui.QApplication.UnicodeUTF8))
        self.appendTypeCheckBox.setToolTip(QtGui.QApplication.translate("dlgConfigureBatchIndicatorVisualization", "Checking this appends an abbreviated column type to the column title in the .tab ASCII file, the ':i4' in 'population_2010:i4'", None, QtGui.QApplication.UnicodeUTF8))
