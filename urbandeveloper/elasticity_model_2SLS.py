...
class elasticity_model(object):
    ...
    def estimate_elasticity(self, zones):
        ...
        imat_names = ['non_res_price','land_value','avg_far']
        ...
        # x = x.as_matrix()
        #
        # imat = zones[['ln_avg_nonres_unit_price_zone','ln_avg_land_value_per_sqft_zone','median_year_built']]
        # imat = imat.fillna(0)
        # imat = imat.as_matrix()
        #
        # yend = zones['ln_avg_unit_price_zone']
        ...
        #
        #
        # imat_names = ['non_res_price','land_value','median_year_built']
        # x_names = ['zonal_pop', 'mean_income', 'ln_jobs_within_30min', 'zone_contains_park']
        # yend_name = ['ln_avg_unit_price_zone']
        # y_name = 'residential_sqft_zone'
        #
